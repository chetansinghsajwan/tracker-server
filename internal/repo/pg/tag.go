...
func NewPostgresTagRepo(db *sql.DB) repo.TagRepo {
	return &postgresTagRepo{db: db}
}

func (r *postgresTagRepo) Create(ctx context.Context, tag *repo.Tag) error {
...
func (r *postgresTagRepo) GetByID(ctx context.Context, id int64) (*repo.Tag, error) {
...
func (r *postgresTagRepo) ListByUserID(ctx context.Context, userID string) ([]*repo.Tag, error) {
...
func (r *postgresTagRepo) Update(ctx context.Context, tag *repo.Tag) error {
	query := `UPDATE tags SET name = $1 WHERE id = $2`
	_, err := r.db.ExecContext(ctx, query, tag.Name, tag.ID)
	return err
}

func (r *postgresTagRepo) Delete(ctx context.Context, id int64) error {
